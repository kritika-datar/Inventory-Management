<?php
	...
	{
		$query="update masterims set status=1,approved_date='$date' where Indent_id='$id'";
		$result=mysqli_query($connection,$query);
		foreach($_POST['par'] as $row=>$par)
		{
			$particular=$par;
			$aq=$_POST['aq'][$row];
			$involve="update childims set Approved='$aq' where Particular='$particular' and Indent_id='$id'";
...
<html>
	...
	<body style="background-color:#ffff99;">
		...
		<a href="new_list.php" style="color:blue; text-decoration:none;font-size: 18px; float: right;margin-right:20px;"><< <b>Back to Home</b></a>
