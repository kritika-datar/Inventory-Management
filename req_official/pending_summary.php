...
<html>
	...
	<div>
		<?php  
			...
			{	 
					...
					echo "</table>";
					echo "<center><br><br><input type='button' onclick='window.print()' value='Print'></center></div>";
			}
		?>
	...
	<br><br>
	<a href="pending_list.php" style="color:blue; text-decoration:none;font-size: 18px; float: right;margin-right:20px;"><< <b>Back</b></a>
	</body>
</html>