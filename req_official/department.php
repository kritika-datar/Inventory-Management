...
<div >
<form>
<input style="margin-right: 20px;" type="button" onclick="location.href='utd_list.php'; " value="UTD"/>
<input style="margin-right: 20px;" type="button" onclick="location.href='rnt_list.php';" value="RNT"/>
<br/>
</form>
</div>
