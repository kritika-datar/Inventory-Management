...
echo "<table border='3'cellpadding='4' cellspacing='4'><tr align='center'>";
...
?><br><br><br><br>
		...
		<a href="deaddept.php" style="color:blue; text-decoration:none;font-size: 18px; float: right;margin-right:20px;"><< <b>Back</b></a>
	</body>
</html>