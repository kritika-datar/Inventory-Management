...
<html>
	...
	<div>
		<?php  
			...
			{	 
					...
					echo "</table>";
					echo "<center><br><br><form action='approved_handler.php' method='post'><input type='submit' name='submit' value='Dispatch'>";
					echo "&nbsp; &nbsp; <input type='button' onclick='window.print()' value='Print'></center></div></form>";
			}
		?>
	...
	<br><br>
<a href="approved_list.php" style="color:blue; text-decoration:none;font-size: 18px; float: right;margin-right:20px;"><< <b>Back</b></a>
	</body>
</html>