...
$result = mysqli_query($conn,"SELECT particular,qty FROM stocklist where type='stock' order by particular");
if (!$result)
die("Could not retreive data" . mysql_error());
 $rowcount=mysqli_num_rows($result);
 if($rowcount>0)
 {?>
  <div Style="font-size:20px; color:blue;"><b> Stock Balance Report</b></div><br>
	 <?php
...
echo "<td><form method='post' action='view_handler1.php'><input type='text' Size='50' value='".$row['particular']."' name='particular' readonly></td>";
